...
export const isPatched = (state: UserStoreState): boolean => state.patched;
...
export const selectIsPatched: MemoizedSelector<object, boolean> = createSelector(selectUserStoreState, isPatched);
